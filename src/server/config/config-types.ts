...
export const CLE_TO_FIELD: Record<string, keyof ResolvedConfig> = {
  ...
  HCSF_TAUX_REFERENCE_CAPACITE: 'hcsfTauxReferenceCapacite',
  HCSF_DUREE_CAPACITE_RESIDUELLE_ANNEES: 'hcsfDureeCapaciteResiduelleAnnees',
  HCSF_DUREE_MAX_ANNEES_VEFA: 'hcsfDureeMaxAnneesVefa',
  ...
  NOTAIRE_DMTO_TAUX_STANDARD: 'notaireDmtoTauxStandard',
  NOTAIRE_CSI_TAUX: 'notaireCsiTaux',
  NOTAIRE_DEBOURS_FORFAIT: 'notaireDeboursForfait',
...
export interface ResolvedConfig {
  ...
  hcsfTauxReferenceCapacite: number;
  hcsfDureeCapaciteResiduelleAnnees: number;
  hcsfDureeMaxAnneesVefa: number;
  // DPE
  decoteDpeFg: number;
  decoteDpeE: number;
  // LMP / Scoring
  ...
  notaireDmtoTauxStandard: number;
  notaireCsiTaux: number;
  notaireDeboursForfait: number;
  // Projections
