      ...
      <div className="bg-white rounded-2xl shadow-2xl w-full max-w-md overflow-hidden transform transition-all">
        ...
        <div className="bg-slate-50 p-4 flex justify-end gap-3">
          ...
          <button
            ...
            className={`px-6 py-2 bg-forest text-white font-semibold rounded-lg shadow-md hover:bg-forest-dark active:transform active:scale-95 transition-all flex items-center gap-2 ${
              !name.trim() || createSimulation.isPending ? 'opacity-50 cursor-not-allowed' : ''
            }`}
          >
