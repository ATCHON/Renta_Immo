        ...
        <div className="fixed inset-0 bg-black/50 flex items-center justify-center p-4 z-50 backdrop-blur-sm">
            <div className="bg-white rounded-2xl p-8 max-w-md w-full shadow-2xl animate-in fade-in zoom-in duration-200 max-h-[90vh] overflow-y-auto">
                ...
                <div className="space-y-4">
                    <div>
                        <label className="block text-sm font-medium text-slate-700 mb-1">Nouvelle valeur ({param.unite})</label>
                        <input
                            type="number"
                            step="0.0001"
                            value={newValue}
                    ...
                    <div>
                        <label className="block text-sm font-medium text-slate-700 mb-1">Motif du changement (obligatoire)</label>
                        <textarea
                            value={motif}
