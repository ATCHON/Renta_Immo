          ...
          <div className="hidden md:flex items-center space-x-4">
            {isPending ? (
              ...
              <div className="flex items-center space-x-4">
                <Link
                  href="/account"
                  className="flex items-center space-x-2 text-sm font-medium text-charcoal hover:text-forest transition-colors"
                >
                  {session.user.image ? (
                    <Image
                ...
                <Button
                  ...
                  className="text-pebble hover:text-red-600 border-sand"
                >
              ...
              <Link href="/auth/login" passHref>
                <Button
                  variant="secondary"
                  size="sm"
                  className="border-sand text-charcoal hover:bg-sand/30"
                >
                  Connexion
                </Button>
              </Link>
        ...
        <div className="fixed inset-x-0 top-16 z-40 md:hidden bg-white overflow-y-auto border-t border-sand h-[calc(100dvh-4rem)]">
          <div className="px-4 py-6 space-y-2 pb-20">
            ...
            <div className="pt-4 space-y-3">
              <Button
                variant="primary"
                className="w-full py-6 text-lg rounded-2xl shadow-lg shadow-forest/10"
                onClick={() => {
              ...
              {session ? (
                ...
                <Link href="/auth/login" onClick={() => setIsMenuOpen(false)} passHref>
                  <Button
                    variant="secondary"
                    className="w-full py-6 text-lg rounded-2xl border-sand text-charcoal"
                  >
                    Se connecter
                  </Button>
                </Link>
