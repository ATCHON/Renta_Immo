...
export const CONSTANTS = {
  ...
  NOTAIRE: {
    ...
    BAREME_EMOLUMENTS: [
      { SEUIL: 6500, TAUX: 0.0387 },
      { SEUIL: 17000, TAUX: 0.01596 },
      { SEUIL: 60000, TAUX: 0.01064 },
      { SEUIL: Infinity, TAUX: 0.00799 },
    ],
    TVA_EMOLUMENTS: 0.2, // 20%

    // Droits de mutation (DMTO)
    DMTO: {
      TAUX_DEPARTEMENTAL_STANDARD: 0.045, // 4.5%
      TAUX_DEPARTEMENTAL_MAJOR: 0.05, // 5.0% (Hausse 2025 possible)
      TAUX_COMMUNAL: 0.012, // 1.2%
