...
const TOC_ITEMS = [
  ...
  { id: 'cashflow', label: 'Trésorerie & Cash-flow' },
  { id: 'credit', label: 'Crédit' },
  { id: 'assurance-crd', label: 'Assurance CRD' },
  { id: 'fiscalite', label: 'Fiscalité' },
  { id: 'deficit-foncier', label: 'Déficit foncier' },
  { id: 'amortissement', label: 'Amortissement' },
  { id: 'plus-value', label: 'Plus-value' },
  { id: 'hcsf', label: 'HCSF' },
  { id: 'dpe', label: 'DPE' },
  { id: 'scoring', label: 'Scoring' },
  { id: 'profils', label: 'Profils Investisseur' },
    ...
    >
      ...
      >
        <span className="text-xs font-bold text-pebble uppercase tracking-widest">
          {activeId
            ? (TOC_ITEMS.find((i) => i.id === activeId)?.label ?? 'Navigation')
            : 'Navigation'}
        </span>
        <ChevronDown
...
const PIPELINE_STEPS = [
  {
    icon: ShieldCheck,
    label: 'Validation',
    sub: 'Normalisation des entrées',
    href: '#rentabilite',
  },
  {
    icon: TrendingUp,
    label: 'Rentabilité',
    sub: 'Crédit, charges, rendements',
    href: '#rentabilite',
  },
        ...
        <div className="flex gap-12 items-start">
          ...
          <div className="flex-1 min-w-0 space-y-12">
            ...
            <header>
              ...
              <h1 className="text-4xl font-bold text-charcoal tracking-tight">Comment ça marche</h1>
              <p className="text-pebble mt-3 text-lg leading-relaxed max-w-2xl">
                Comprendre les calculs, formules et valeurs réglementaires utilisés par notre moteur
                d&apos;analyse immobilière. Valeurs à jour pour <strong>2026</strong>.
              </p>
            </header>
            ...
            <div className="space-y-10">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                  <Card>
                    ...
                    <CardContent className="space-y-4">
                      ...
                      <p className="text-sm text-pebble leading-relaxed">
                        Le ratio le plus simple. Il ne prend pas en compte les charges ni les
                        impôts. Un investissement à 6% brut génère 6€ de loyer par an pour 100€
                        investis.
                      </p>
                      <ExpertTip variant="info">
                        <strong>Repère :</strong> En province, visez 8-10%. En grande métropole,
                        5-7% est déjà correct. En dessous de 4%, l&apos;investissement repose
                        essentiellement sur la plus-value.
                      </ExpertTip>
                    </CardContent>
                  </Card>
                  ...
                  <Card>
                    ...
                    <CardContent className="space-y-4">
                      ...
                      <p className="text-sm text-pebble leading-relaxed">
                        Prend en compte toutes les charges : taxe foncière, copropriété, assurance
                        PNO, frais de gestion, provision travaux et vacance locative.
                      </p>
                      <p className="text-sm text-pebble leading-relaxed">
                        En moyenne, les charges représentent 25 à 35% du loyer brut. La rentabilité
                        nette est donc généralement 2 à 3 points inférieure à la brute.
                      </p>
                    </CardContent>
                  </Card>
                    ...
                    <CardContent className="space-y-4">
                      <FormulaBox highlight>
                        <span className="flex flex-col md:flex-row justify-between items-center gap-4">
                          ...
                          <span className="text-xs bg-forest text-white px-3 py-1 rounded-full not-italic font-bold">
                            Le plus précis
                          </span>
                        </span>
                      </FormulaBox>
                      <p className="text-sm text-pebble leading-relaxed">
                        C&apos;est la rentabilité réelle après paiement de tous les impôts et
                        prélèvements sociaux. Elle varie considérablement selon votre régime fiscal
                        et votre TMI. C&apos;est cet indicateur qui compte vraiment pour comparer
                        deux investissements entre eux.
                      </p>
                      <ExpertTip variant="success">
                        <strong>
                          Notre simulateur calcule cette rentabilité pour les 6 régimes fiscaux
                        </strong>{' '}
                        et vous recommande le plus avantageux. Un même bien peut passer de -2%
                        nette-nette en micro-foncier à +3% en LMNP réel.
                      </ExpertTip>
                    </CardContent>
                  </Card>
                </div>
              ...
              <section id="cashflow" className="space-y-6 scroll-mt-8">
                ...
                <p className="text-sm text-pebble leading-relaxed">
                  ...
                  réalité de votre compte en banque à la fin du mois. C&apos;est la différence entre
                  ce qui rentre (loyers) et ce qui sort (charges, crédit, impôts).
                </p>

                <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
                  <Card>
                    <CardHeader title="Cash-flow Brut" description="Indicateur rapide banque" />
                    <CardContent className="space-y-4">
                      <FormulaBox>Loyer mensuel - Mensualité crédit</FormulaBox>
                      <p className="text-sm text-pebble leading-relaxed">
                        Ce qu&apos;il reste pour payer les charges et impôts. Si négatif dès ce
                        stade, l&apos;effort d&apos;épargne sera important.
                      </p>
                    </CardContent>
                  </Card>
                  ...
                  <Card>
                    ...
                    <CardContent className="space-y-4">
                      ...
                      <p className="text-sm text-pebble leading-relaxed">
                        Votre trésorerie réelle mois après mois, avant la régularisation fiscale
                        annuelle. C&apos;est l&apos;argent disponible sur le compte dédié à
                        l&apos;investissement.
                      </p>
                    </CardContent>
                  </Card>
                  ...
                  <Card className="bg-forest/5 border-forest/10">
                    ...
                    <CardContent className="space-y-4">
                      ...
                      <p className="text-sm text-pebble leading-relaxed">
                        Ce qui rentre <strong>réellement</strong> dans votre poche une fois tout
                        payé. Le terme &ldquo;Impôts&rdquo; inclut ici la somme de votre{' '}
                        <strong>Impôt sur le Revenu</strong> (selon votre TMI) et des{' '}
                        <strong>Prélèvements Sociaux</strong> (17.2%), ou l&apos;Impôt sur les
                        Sociétés (IS) pour une SCI.
                      </p>
                      <ExpertTip variant="success">
                        <strong>Positif ?</strong> Vous gagnez de l&apos;argent chaque mois.
                        L&apos;investissement s&apos;autofinance et génère un revenu complémentaire.
                      </ExpertTip>
                    </CardContent>
                  </Card>
                </div>
                    ...
                    <div className="flex flex-col md:flex-row gap-6 items-center">
                      <div className="flex-1 space-y-4">
                        <p className="text-sm text-pebble leading-relaxed">
                          ...
                          <strong>effort d&apos;épargne</strong>. Vous devez sortir 150€ de votre
                          salaire chaque mois pour combler le déficit.
                        </p>
                        <ExpertTip variant="warning">
                          <strong>Stratégie :</strong> Un effort d&apos;épargne n&apos;est pas
                          forcément mauvais s&apos;il permet d&apos;acquérir un patrimoine important
                          (stratégie patrimoniale). Mais il réduit votre capacité d&apos;emprunt
                          future.
                        </ExpertTip>
                      </div>
                  ...
                  <CardContent>
                    <div className="space-y-6">
                      ...
                      <div className="grid grid-cols-2 md:grid-cols-3 gap-4 text-xs font-medium text-pebble">
                        <div className="bg-sand/10 p-3 rounded-lg border border-sand/30">
                          <strong className="text-charcoal">M</strong> : Mensualité totale
                        </div>
                        <div className="bg-sand/10 p-3 rounded-lg border border-sand/30">
                          <strong className="text-charcoal">C</strong> : Capital emprunté
                        </div>
                        <div className="bg-sand/10 p-3 rounded-lg border border-sand/30">
                          <strong className="text-charcoal">t</strong> : Taux mensuel (Annuel / 12)
                        </div>
                        <div className="bg-sand/10 p-3 rounded-lg border border-sand/30">
                          <strong className="text-charcoal">n</strong> : Nombre de mensualités
                        </div>
                        <div className="bg-sand/10 p-3 rounded-lg border border-sand/30">
                          <strong className="text-charcoal">Assurance</strong> : Capital x Taux / 12
                        </div>
                      </div>
                      <ExpertTip>
                        <strong>Exemple :</strong> Pour 200 000€ à 3.5% sur 20 ans (assurance 0.3%),
                        la mensualité est d&apos;environ{' '}
                        <span className="font-bold underline">1 210€</span> dont 50€
                        d&apos;assurance. Le coût total du crédit est de ~90 000€ d&apos;intérêts +
                        ~12 000€ d&apos;assurance.
                      </ExpertTip>
                      <ExpertTip variant="success">
                        <strong>L&apos;effet de levier :</strong> Emprunter à 3.5% pour investir
                        dans un bien qui rapporte 6% net, c&apos;est gagner 2.5% sur de
                        l&apos;argent que vous n&apos;avez pas. C&apos;est le principe fondamental
              ...
              <section id="assurance-crd" className="space-y-6 scroll-mt-8">
                ...
                <Card>
                  ...
                  <CardContent className="space-y-6">
                    <p className="text-sm text-pebble leading-relaxed">
                      L&apos;assurance emprunteur peut être calculée de deux façons. Le choix du
                      mode impacte le coût total du crédit, le cash-flow mensuel et le TRI de votre
                      investissement.
                    </p>
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                      ...
                      <div className="bg-forest/5 p-5 rounded-xl border border-forest/10">
                        ...
                        <p className="text-sm text-pebble leading-relaxed mt-3">
                          Mensualité <strong>dégressive</strong> : élevée au début, quasi nulle à la
                          fin. Mode courant en délégation d&apos;assurance (loi Lemoine 2022).
                        </p>
                    ...
                    <ExpertTip variant="success">
                      <strong>Impact sur l&apos;investissement :</strong> En mode CRD,
                      l&apos;économie de ~4 800€ sur 20 ans améliore le cash-flow en fin de crédit
                      et augmente le TRI de 0.1 à 0.2 point. En LMNP réel / SCI IS, l&apos;assurance
                      déductible diminue chaque année, ce qui augmente légèrement la base imposable
                      en fin de crédit.
                    </ExpertTip>

                    <ExpertTip variant="warning">
                      <strong>HCSF :</strong> Pour l&apos;analyse d&apos;endettement, la mensualité
                      maximale (An 1) est retenue dans les deux modes. Le mode CRD n&apos;offre donc
                      pas d&apos;avantage pour le taux d&apos;endettement.
                    </ExpertTip>
                  </CardContent>
                </Card>
              </section>
              ...
              <section id="fiscalite" className="space-y-6 scroll-mt-8">
                ...
                <p className="text-sm text-pebble leading-relaxed">
                  Le choix du régime fiscal est déterminant : il peut faire basculer un
                  investissement de déficitaire à rentable. Notre simulateur compare{' '}
                  <strong>6 régimes</strong> pour trouver celui qui maximise votre cash-flow net.
                </p>
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                  <Card>
                    ...
                    <CardContent className="space-y-4">
                      ...
                      <p className="text-sm text-pebble leading-relaxed">
                        Abattement forfaitaire de 30% sur les revenus fonciers. Base imposable = 70%
                        des loyers, soumise au barème IR + prélèvements sociaux (17.2%).
                      </p>
                      <ExpertTip variant="warning">
                        <strong>Pour qui ?</strong> Investisseurs avec peu de charges (&lt;30% des
                        loyers) et revenus fonciers &lt;15 000€/an. Si vos charges dépassent 30%, le
                        régime réel est plus avantageux.
                      </ExpertTip>
                    </CardContent>
                  </Card>
                  ...
                  <Card>
                    <CardHeader
                      title="Foncier Réel"
                      description="Location nue — Le plus puissant"
                    />
                    <CardContent className="space-y-4">
                      <div className="grid grid-cols-2 gap-3">
                      ...
                      <p className="text-sm text-pebble leading-relaxed">
                        Déduction de toutes les charges réelles : intérêts d&apos;emprunt, travaux,
                        assurance, taxe foncière, frais de gestion, etc. Permet de créer un{' '}
                        <strong>déficit foncier</strong>.
                      </p>
                      <p className="text-sm text-pebble leading-relaxed">
                        Idéal en cas de gros travaux : le déficit foncier peut effacer l&apos;impôt
                  ...
                  <Card>
                    ...
                    <CardContent className="space-y-4">
                      ...
                      <p className="text-sm text-pebble leading-relaxed">
                        Abattement forfaitaire sur les recettes locatives meublées selon la nature
                        du bien. Simple et souvent avantageux pour les petites surfaces meublées en
                        longue durée.
                      </p>
                      <ExpertTip variant="warning">
                        <strong>LF 2025 :</strong> Le taux pour les meublés de tourisme non classés
                        a été réduit à 30% avec un plafond de 15 000€. Les meublés de tourisme{' '}
                        <strong>classés</strong> conservent un abattement majoré à 71% (plafond 188
                        700€).
                      </ExpertTip>
                      <ExpertTip variant="info">
                        <strong>PS 18,6% (LFSS 2026) :</strong> Les revenus locatifs meublés (BIC)
                        sont soumis aux prélèvements sociaux à <strong>18,6%</strong>, contre 17,2%
                        pour les revenus fonciers (location nue). Cette différence s&apos;applique à
                  ...
                  <Card>
                    <CardHeader
                      title="LMNP Réel"
                      description="Meublé — Le roi de la défiscalisation"
                    />
                    <CardContent className="space-y-4">
                      <div className="grid grid-cols-2 gap-3">
                      ...
                      <p className="text-sm text-pebble leading-relaxed">
                        Le régime le plus avantageux fiscalement. L&apos;amortissement comptable du
                        bâti, du mobilier et des travaux permet souvent de ramener l&apos;impôt à
                        zéro pendant de nombreuses années.
                      </p>
                      <p className="text-sm text-pebble leading-relaxed">
                        <strong>Important :</strong> L&apos;amortissement ne peut pas créer de
                        déficit BIC. L&apos;excédent est reporté indéfiniment sur les exercices
                        suivants.
                      </p>
                      <ExpertTip variant="warning">
                        <strong>PS 18,6% sur revenus BIC (LFSS 2026) :</strong> Même avec un
                        résultat fiscal nul grâce aux amortissements, si un bénéfice BIC subsiste,
                        il est soumis aux prélèvements sociaux à <strong>18,6%</strong> (taux BIC),
                        distincts des 17,2% applicables aux revenus fonciers de la location nue.
                      </ExpertTip>
                    </CardContent>
                  </Card>
                  ...
                  <Card className="md:col-span-2 bg-gradient-to-br from-surface to-cream border-sand shadow-sm">
                    ...
                    <CardContent className="space-y-4">
                      <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
                        <div className="bg-white/60 backdrop-blur-sm p-4 rounded-xl border border-sand/30">
                          ...
                          <p className="text-2xl font-black text-charcoal">
                            15%{' '}
                            <span className="text-xs font-normal text-pebble">
                              (jusqu&apos;à 42 500€)
                            </span>
                          </p>
                        </div>
                        <div className="bg-white/60 backdrop-blur-sm p-4 rounded-xl border border-sand/30">
                          ...
                          <p className="text-2xl font-black text-charcoal">
                            25% <span className="text-xs font-normal text-pebble">(au-delà)</span>
                          </p>
                        </div>
                        <div className="bg-white/60 backdrop-blur-sm p-4 rounded-xl border border-sand/30">
                          <p className="text-xs font-bold text-pebble uppercase tracking-wider mb-2">
                      ...
                      <p className="text-sm text-pebble leading-relaxed">
                        ...
                        de fonctionnement : <strong>capitalisation</strong> (les bénéfices restent
                        dans la SCI) ou <strong>distribution</strong> (dividendes soumis à la flat
                        tax de 30%).
                      </p>
                      <ExpertTip variant="warning">
                        <strong>Attention à la revente :</strong> En SCI IS, la plus-value est
                        calculée sur la valeur nette comptable (après amortissements). L&apos;impôt
                        de plus-value est donc beaucoup plus élevé qu&apos;en nom propre. Voir la
                        section{' '}
                        <a href="#plus-value" className="underline font-bold">
                          Plus-value
                        </a>{' '}
                        ci-dessous.
                      </ExpertTip>
              ...
              <section id="deficit-foncier" className="space-y-6 scroll-mt-8">
                ...
                <Card>
                  ...
                  <CardContent className="space-y-6">
                    <p className="text-sm text-pebble leading-relaxed">
                      Quand vos charges déductibles (travaux, intérêts, assurance...) dépassent vos
                      revenus fonciers, vous êtes en <strong>déficit foncier</strong>. Ce déficit se
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                      <div className="bg-forest/5 p-5 rounded-xl border border-forest/10">
                        ...
                        <p className="text-sm text-pebble leading-relaxed">
                          Imputable sur votre <strong>revenu global</strong> (salaires, etc.) dans
                          la limite de <strong className="text-forest">10 700€/an</strong>.
                        </p>
                        <p className="text-sm text-pebble leading-relaxed mt-2">
                          C&apos;est la partie la plus intéressante : elle réduit directement votre
                          impôt sur le revenu.
                        </p>
                      </div>
                      <div className="bg-surface p-5 rounded-xl border border-sand">
                        <h4 className="text-sm font-bold text-charcoal mb-2">
                          Déficit lié aux intérêts
                        </h4>
                        <p className="text-sm text-pebble leading-relaxed">
                    ...
                    <ExpertTip variant="success">
                      <strong>Travaux de rénovation énergétique (LF 2023) :</strong> Pour les
                      dépenses de rénovation énergétique réalisées entre 2023 et 2025, le plafond du
                      déficit foncier imputable sur le revenu global est majoré à{' '}
                    ...
                    <ExpertTip>
                      <strong>Exemple concret :</strong> Revenus fonciers 10 800€, charges (travaux)
                      18 000€, intérêts 5 000€. Déficit total = 12 200€. Dont 7 200€ hors intérêts
                      imputable sur revenu global. À TMI 30%, l&apos;économie d&apos;impôt est de{' '}
                      <strong>2 160€</strong>.
                    </ExpertTip>
                    <ExpertTip variant="warning">
                      <strong>Condition :</strong> En contrepartie de l&apos;imputation sur le
                      revenu global, vous devez conserver le bien en location pendant{' '}
                      <strong>3 ans minimum</strong> après l&apos;imputation.
                    </ExpertTip>
                  </CardContent>
                </Card>
              </section>
              ...
              <section id="amortissement" className="space-y-6 scroll-mt-8">
                ...
                <div className="grid grid-cols-1 gap-6">
                  <Card>
                    ...
                    <CardContent className="space-y-6">
                      <p className="text-sm text-pebble leading-relaxed">
                        L&apos;amortissement permet de déduire chaque année une fraction de la
                        valeur du bien de vos revenus imposables. Seule la partie{' '}
                        <strong>bâti</strong> est amortissable — le terrain ne l&apos;est pas.
                      </p>
                      ...
                      <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                        <div className="bg-surface p-5 rounded-xl border border-sand">
                          ...
                          <p className="text-sm text-pebble leading-relaxed mb-3">
                            Amortissement linéaire sur <strong>33 ans</strong> (~3%/an) pour
                            l&apos;ensemble du bâti. Simple mais sous-estime l&apos;amortissement
                            réel.
                          </p>
                        ...
                        <div className="bg-forest/5 p-5 rounded-xl border border-forest/10">
                          ...
                          <p className="text-sm text-pebble leading-relaxed mb-3">
                            Décomposition du bâti en composants avec des durées différentes. Plus
                            précis et plus avantageux les premières années.
                          </p>
                      ...
                      <div className="overflow-x-auto">
                        <table className="w-full text-sm">
                          <thead>
                            <tr className="border-b border-sand">
                              <th className="text-left py-2 text-pebble font-bold text-xs uppercase">
                                Composant
                              </th>
                              <th className="text-center py-2 text-pebble font-bold text-xs uppercase">
                                Part
                              </th>
                              <th className="text-center py-2 text-pebble font-bold text-xs uppercase">
                                Durée
                              </th>
                              <th className="text-right py-2 text-pebble font-bold text-xs uppercase">
                                Amort./an*
                              </th>
                            </tr>
                          </thead>
                          <tbody className="text-charcoal">
                            ...
                            <tr className="border-t-2 border-forest/20">
                              <td className="py-2 font-black text-forest" colSpan={3}>
                                Total
                              </td>
                        ...
                        <p className="text-[10px] text-pebble mt-2">
                          *Exemple : bien 200 000€, terrain 15%, valeur amortissable 170 000€
                        </p>
                      </div>

                      <ExpertTip variant="info">
                        <strong>Arrêt progressif :</strong> L&apos;amortissement diminue au fil du
                        temps. Les agencements s&apos;arrêtent après <strong>10 ans</strong>, les
                        installations après <strong>15 ans</strong>, la façade après{' '}
                        <strong>25 ans</strong>. Seul le gros oeuvre continue jusqu&apos;à{' '}
                      ...
                      <ExpertTip variant="warning">
                        <strong>Règle fondamentale :</strong> L&apos;amortissement ne peut pas créer
                        de <strong>déficit BIC</strong>. Si l&apos;amortissement dépasse le
                        bénéfice, l&apos;excédent est reporté sans limite de durée sur les exercices
                        suivants. Il n&apos;est jamais perdu.
                      </ExpertTip>
                    </CardContent>
                  </Card>
                </div>
                ...
                <div className="grid grid-cols-1 gap-6">
                  ...
                  <Card>
                    ...
                    <CardContent className="space-y-6">
                      ...
                      <ExpertTip>
                        <strong>Exemple :</strong> Achat 200 000€, revente 230 000€ après 10 ans. PV
                        brute = 30 000€. Abattement IR 30% → IR = 21 000€ x 19% ={' '}
                        <strong>3 990€</strong>. Abattement PS 8.25% → PS = 27 525€ x 17.2% ={' '}
                        <strong>4 734€</strong>. Total = <strong>8 724€</strong>.
                      </ExpertTip>
                  ...
                  <Card>
                    ...
                    <CardContent className="space-y-4">
                      ...
                      <p className="text-sm text-pebble leading-relaxed">
                        Depuis la <strong>loi de finances 2025</strong>, les amortissements déduits
                        en LMNP sont réintégrés dans le calcul de la plus-value lors de la revente.
                        Les abattements pour durée de détention s&apos;appliquent ensuite
                        normalement.
                      </p>
                      <ExpertTip variant="warning">
                        <strong>Impact concret :</strong> Si vous avez amorti 50 000€ sur 10 ans,
                        votre plus-value brute augmente de 50 000€. C&apos;est le prix à payer pour
                        des années d&apos;impôt zéro. À long terme (&gt;22 ans), l&apos;exonération
                        IR compense largement.
                      </ExpertTip>
                      <ExpertTip variant="success">
                        ...
                        <strong>exemptés</strong> de la réintégration des amortissements dans le
                        calcul de la plus-value. Ils continuent de bénéficier du régime de la
                        plus-value des particuliers sans majoration.
                      </ExpertTip>
                    </CardContent>
                  </Card>
                  ...
                  <Card>
                    ...
                    <CardContent className="space-y-6">
                      ...
                      <p className="text-sm text-pebble leading-relaxed">
                        En SCI IS, la plus-value est calculée sur la{' '}
                        <strong>valeur nette comptable</strong>. Après des années
                        d&apos;amortissement, la VNC peut être très faible, ce qui génère une
                        plus-value imposable importante. <strong>Aucun abattement</strong> pour
                        durée de détention.
                      </p>
                      ...
                      <ExpertTip variant="warning">
                        <strong>Exemple frappant :</strong> Achat 200 000€, revente 230 000€ après
                        10 ans (amortissements 51 510€). En <strong>nom propre : 8 724€</strong>{' '}
                        d&apos;impôt PV. En <strong>SCI IS avec distribution : 35 742€</strong>.
                        Soit <strong>4x plus</strong>. La SCI IS est un outil de capitalisation long
                        terme, pas de revente rapide.
                      </ExpertTip>
                    </CardContent>
                  </Card>
                </div>
                ...
                <Card>
                  <CardContent className="pt-6">
                    ...
                    <div className="space-y-4">
                      ...
                      <ExpertTip>
                        <strong>Marge de flexibilité :</strong> Les banques disposent d&apos;une
                        dérogation de <strong>20%</strong> sur leurs dossiers. Cette marge est
                        souvent réservée aux profils à haut reste à vivre (&gt;1 500€/mois après
                        charges) ou aux primo-accédants résidence principale. Les investisseurs
                        locatifs y ont rarement accès.
                      </ExpertTip>
                      <h4 className="text-sm font-bold text-charcoal uppercase tracking-widest px-3 border-l-4 border-forest mt-6">
                        Reste à vivre
                      </h4>
                      <p className="text-sm text-pebble leading-relaxed">
                        Le reste à vivre est le montant qui reste chaque mois après paiement de
                        toutes vos charges et crédits. Les banques l&apos;utilisent systématiquement{' '}
                        <strong>en complément du taux d&apos;endettement</strong> pour évaluer la
                      ...
                      <ExpertTip variant="success">
                        ...
                        <strong>0 point</strong> entre 800 et 1 500€, et <strong>-10 points</strong>{' '}
                        en dessous de 800€. Un investisseur peut être sous le seuil de 35%
                        d&apos;endettement mais avoir un reste à vivre insuffisant, ce qui
                        entraînerait un refus de prêt.
                      </ExpertTip>
                    </div>
                  </CardContent>
                </Card>
                ...
                <Card>
                  ...
                  <CardContent className="space-y-6">
                    <p className="text-sm text-pebble leading-relaxed">
                      ...
                      <strong>valeur du bien</strong>, la <strong>capacité à louer</strong>
                    ...
                    <div className="grid grid-cols-7 gap-2">
                      {[
                        ...
                        <div
                          key={dpe.label}
                          className={cn(
                            'rounded-lg p-3 text-center font-black text-lg',
                            dpe.color,
                            dpe.text
                          )}
                        >
                    ...
                    <p className="text-sm text-pebble leading-relaxed">
                      Les logements classés <strong>F ou G</strong> ne peuvent plus faire
                      l&apos;objet d&apos;une augmentation de loyer depuis 2022 : l&apos;IRL (Indice
                      de Référence des Loyers) est <strong>inapplicable</strong>. Le DPE{' '}
                      <strong>E</strong> sera soumis au même gel à partir du{' '}
                      <strong>1er janvier 2034</strong>, date à laquelle sa location sera interdite.
                    </p>
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                      <div className="bg-surface p-4 rounded-xl border border-sand">
                        <p className="text-xs font-bold text-pebble uppercase tracking-wider mb-1">
                        ...
                        <p className="text-sm text-charcoal">
                          Loyer revalorisé selon l&apos;IRL chaque année (<strong>+2%/an</strong> en
                          moyenne)
                        </p>
                      </div>
                      <div className="bg-terracotta/5 p-4 rounded-xl border border-terracotta/10">
                    ...
                    <ExpertTip variant="warning">
                      <strong>Impact concret :</strong> Pour un loyer de 900€/mois, le gel
                      représente un manque à gagner de{' '}
                      <strong>~175€/mois à l&apos;horizon 10 ans</strong> par rapport à un DPE C
                      avec inflation de 2%. Notre simulateur applique automatiquement le gel pour
                      les DPE F et G.
                    </ExpertTip>
                    ...
                    <ExpertTip variant="warning">
                      ...
                      <strong>+5 points</strong>, un DPE E un malus de <strong>-3 points</strong>,
                      et un DPE F ou G (passoire) un malus de <strong>-10 points</strong>. Le
                      simulateur émet des alertes spécifiques si l&apos;interdiction de location
                      tombe avant la fin de votre horizon de projection.
                    </ExpertTip>
                    <ExpertTip variant="success">
                      <strong>Opportunité :</strong> Un bien en DPE F ou G acheté avec décote +
                      travaux de rénovation énergétique peut être une excellente opération : vous
                      bénéficiez du <strong>déficit foncier</strong> sur les travaux tout en
                      augmentant la valeur et la performance du bien. Vérifiez votre éligibilité à{' '}
                      <strong>MaPrimeRénov&apos;</strong> pour réduire le coût des travaux.
                    </ExpertTip>
                  </CardContent>
                </Card>
              </section>
              ...
              <section id="scoring" className="space-y-6 scroll-mt-8">
                ...
                <Card>
                  ...
                  <CardContent className="space-y-8">
                    <p className="text-sm text-pebble leading-relaxed">
                      Le score part d&apos;une <strong>base de 40 points</strong> (investissement
                      neutre), puis chaque critère apporte un <strong>bonus ou malus</strong> selon
                      la qualité du projet. Le résultat est borné entre 0 et 100.
                    </p>

                    <FormulaBox highlight>
                      Score = 40 (base) + Cashflow + Rentabilité + HCSF + DPE + Ratio prix/loyer +
                      Reste à vivre
                    </FormulaBox>
                      ...
                      {[
                        {
                          ...
                          details: [
                            ...
                            {
                              cond: '0 à +200€',
                              pts: 'Interpolation 0 → +20',
                              color: 'text-charcoal',
                            },
                            {
                              cond: '-200€ à 0',
                              pts: 'Interpolation -20 → 0',
                              color: 'text-charcoal',
                            },
                        ...
                        },
                        {
                          ...
                          details: [
                            ...
                            {
                              cond: '15 à 20',
                              pts: 'Interpolation +10 → 0',
                              color: 'text-charcoal',
                            },
                            {
                              cond: '20 à 25',
                              pts: 'Interpolation 0 → -5',
                              color: 'text-charcoal',
                            },
                      ...
                      {[
                        {
                          range: '80 - 100',
                          label: 'Excellent',
                          sub: 'Opportunité rare, foncez',
                          color: 'bg-forest',
                        },
                        {
                          range: '60 - 79',
                          label: 'Bon',
                          sub: 'Dossier solide à optimiser',
                          color: 'bg-sage',
                        },
                        {
                          range: '40 - 59',
                          label: 'Moyen',
                          sub: 'Points bloquants à résoudre',
                          color: 'bg-amber',
                        },
                        {
                          range: '0 - 39',
                          label: 'Faible',
                          sub: 'Risque élevé, revoir le projet',
                          color: 'bg-terracotta',
                        },
                      ].map((level, id) => (
                        <div key={id} className="flex flex-col items-center text-center gap-2">
                          <div className="flex items-center gap-2">
                            <div
                              className={cn('w-3 h-3 rounded-full shadow-sm', level.color)}
                            ></div>
                            <span className="font-bold text-charcoal tabular-nums text-lg">
                              {level.range}
                            </span>
                          </div>
                          <div>
              ...
              <section id="profils" className="space-y-6 scroll-mt-8">
                ...
                <Card>
                  ...
                  <CardContent className="space-y-6">
                    <p className="text-sm text-pebble leading-relaxed">
                      Un même bien peut être <strong>excellent pour un rentier</strong> (cashflow
                      positif immédiat) et <strong>moyen pour un patrimonial</strong> (TRI
                      insuffisant sur 20 ans), ou vice-versa. Les deux scores sont calculés
                      simultanément côté serveur et affichés sans recalcul.
                    </p>
                    ...
                    <ExpertTip variant="info">
                      ...
                      rentabilité de 3,85% obtient <strong>79.3 en Rentier</strong> (cashflow
                      déterminant) et <strong>85.3 en Patrimonial</strong>
                      (rentabilité et ratio prix/loyer valorisés ×1.5). Même bien, lecture
                      différente selon votre objectif.
                    </ExpertTip>

                    <ExpertTip variant="warning">
                      <strong>Alerte LMP :</strong> En régime LMNP, si vos recettes annuelles
                      dépassent <strong>20 000€</strong> (approche du seuil) ou{' '}
                      <strong>23 000€</strong> (seuil LMP), un bandeau d&apos;alerte s&apos;affiche
                      automatiquement dans les résultats. Au-delà de 23 000€, vous basculez en LMP
                      (Loueur Meublé Professionnel) avec des obligations sociales et fiscales
                      spécifiques.
                    </ExpertTip>
                  </CardContent>
                </Card>
              ...
              <section id="projections" className="space-y-6 scroll-mt-8">
                ...
                <Card>
                  ...
                  <CardContent className="space-y-6">
                    <p className="text-sm text-pebble leading-relaxed">
                      Notre moteur projette votre investissement sur <strong>20 ans</strong> en
                      intégrant toutes les variables qui évoluent dans le temps : inflation des
                      loyers, hausse des charges, remboursement du crédit et fiscalité réelle.
                    </p>
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                      <div className="bg-surface p-5 rounded-xl border border-sand">
                        <h5 className="text-sm font-bold text-charcoal mb-2">
                          TRI (Taux de Rendement Interne)
                        </h5>
                        <p className="text-sm text-pebble leading-relaxed">
                          Le TRI mesure la rentabilité annualisée de votre investissement en prenant
                          en compte
                          <strong> tous les flux</strong> : apport initial, cash-flows annuels nets
                          d&apos;impôt, et valeur de revente nette de plus-value{' '}
                          <strong>et de frais de cession</strong>.
                        </p>
                        <FormulaBox>
                          Flux final = Cash-flow net + Patrimoine net - Impôt PV - Frais de revente
                        </FormulaBox>
                        <p className="text-sm text-pebble leading-relaxed mt-2">
                          C&apos;est l&apos;indicateur le plus complet pour comparer un
                          investissement immobilier avec un placement financier (assurance-vie,
                          bourse, etc.).
                        </p>
                      </div>
                      <div className="bg-surface p-5 rounded-xl border border-sand">
                        ...
                        <p className="text-sm text-pebble leading-relaxed">
                          C&apos;est la mesure réaliste de votre enrichissement, intégrant les flux
                          de trésorerie cumulés :
                        </p>
                        <FormulaBox>
                          Patrimoine net = Valeur du bien - Capital restant dû + Cash-flow net
                          cumulé
                        </FormulaBox>
                        <p className="text-sm text-pebble leading-relaxed mt-2">
                          Contrairement à la simple équité immobilière (valeur − dette), cette
                          formule tient compte de{' '}
                          <strong>tout l&apos;argent investi ou perdu</strong> via le cash-flow
                          mensuel. Un investissement avec un fort effort d&apos;épargne aura un
                          patrimoine net bien inférieur à la valeur du bien.
                        </p>
                      </div>
                    </div>
                    ...
                    <p className="text-sm text-pebble leading-relaxed">
                      Le simulateur intègre les frais réels de cession pour un TRI et un
                      enrichissement total réalistes.
                    </p>
                    <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
                      <div className="bg-surface p-4 rounded-xl border border-sand text-center">
                        <p className="text-xs font-bold text-pebble uppercase tracking-wider">
                        ...
                        <p className="text-2xl font-black text-charcoal">
                          5%
                          <span className="text-xs font-normal text-pebble"> du prix de vente</span>
                        </p>
                      ...
                      <div className="bg-surface p-4 rounded-xl border border-sand text-center">
                        ...
                        <p className="text-2xl font-black text-charcoal">
                          500€<span className="text-xs font-normal text-pebble"> forfait</span>
                        </p>
                    ...
                    <ExpertTip variant="success">
                      <strong>Cash-flow net :</strong> Le tableau de projection montre année par
                      année le cash-flow net d&apos;impôt (loyers − charges − crédit − impôts). Un
                      cash-flow négatif signifie un effort d&apos;épargne mensuel. Suivez
                      l&apos;évolution : avec l&apos;inflation des loyers et la fin du crédit, le
                      cash-flow s&apos;améliore naturellement avec le temps.
                    </ExpertTip>
                        ...
                        <div className="flex items-start gap-2 text-sm">
                          ...
                          <div>
                            ...
                            <p className="text-pebble text-xs">
                              Loyer − Charges − Crédit − Impôts. Vert si positif, rouge si négatif.
                            </p>
                          </div>
                        </div>
                        <div className="flex items-start gap-2 text-sm">
                          ...
                          <div>
                            ...
                            <p className="text-pebble text-xs">
                              Somme de tous les cash-flows nets depuis l&apos;année 1.
                            </p>
                          </div>
                        </div>
                      </div>
                      <div className="bg-surface p-5 rounded-xl border border-sand space-y-3">
                        ...
                        <div className="flex items-start gap-2 text-sm">
                          ...
                          <div>
                            ...
                            <p className="text-pebble text-xs">
                              Prix d&apos;achat + revalorisation annuelle (+1,5%/an par défaut).
                            </p>
                          </div>
                        </div>
                        <div className="flex items-start gap-2 text-sm">
                          ...
                          <div>
                            ...
                            <p className="text-pebble text-xs">
                              Montant d&apos;emprunt restant à rembourser. Atteint 0 à la fin du
                              crédit.
                            </p>
                          </div>
                        </div>
                        <div className="flex items-start gap-2 text-sm">
                          ...
                          <div>
                            ...
                            <p className="text-pebble text-xs">
                              Valeur du bien − Capital restant + Cash-flow net cumulé. Inclut
              ...
              <div className="bg-charcoal text-white rounded-3xl p-8 md:p-12 relative overflow-hidden shadow-2xl">
                <div className="relative z-10 space-y-4">
                  ...
                  <p className="text-stone-light/70 text-sm leading-relaxed max-w-3xl">
                    Ce simulateur fournit des estimations basées sur les informations renseignées et
                    les valeurs réglementaires en vigueur. Les calculs fiscaux sont conformes à la
                    législation 2025-2026, mais des particularités liées à votre situation
                    personnelle peuvent modifier les résultats.
                  </p>
                  <p className="text-stone-light/70 text-sm leading-relaxed max-w-3xl">
                    Pour un conseil personnalisé, consultez un expert-comptable ou un conseiller en
                    gestion de patrimoine (CGP). Les prélèvements sociaux, barèmes d&apos;abattement
                    et seuils fiscaux sont ceux en vigueur au 1er janvier 2026.
                  </p>
                </div>
            ...
            <div className="text-center pt-8">
              <Link href="/calculateur">
                <Button
                  variant="primary"
                  size="lg"
                  className="rounded-full px-12 py-6 text-lg shadow-xl shadow-forest/20"
                >
