        ...
        <div className="space-y-10">
              ...
              <Card>
                ...
                <CardContent className="space-y-4">
                  ...
                  <p className="text-sm text-pebble leading-relaxed">
                    Le ratio le plus simple. Il ne prend pas en compte les charges ni les impôts. Un
                    investissement à 6% brut génère 6€ de loyer par an pour 100€ investis.
                  </p>
                  <ExpertTip variant="info">
                    <strong>Repère :</strong> En province, visez 8-10%. En grande métropole, 5-7%
                    est déjà correct. En dessous de 4%, l&apos;investissement repose essentiellement
                    sur la plus-value.
                  </ExpertTip>
                </CardContent>
              </Card>
              ...
              <Card className="md:col-span-2">
                ...
                <CardContent className="space-y-4">
                  ...
                  <p className="text-sm text-pebble leading-relaxed">
                    ...
                    prélèvements sociaux. Elle varie considérablement selon votre régime fiscal et
                    votre TMI. C&apos;est cet indicateur qui compte vraiment pour comparer deux
                    investissements entre eux.
                  </p>
          ...
          <section id="cashflow" className="space-y-6 scroll-mt-8">
            ...
            <p className="text-sm text-pebble leading-relaxed">
              ...
              réalité de votre compte en banque à la fin du mois. C&apos;est la différence entre ce
              qui rentre (loyers) et ce qui sort (charges, crédit, impôts).
            </p>
              ...
              <Card className="bg-forest/5 border-forest/10">
                ...
                <CardContent className="space-y-4">
                  ...
                  <p className="text-sm text-pebble leading-relaxed">
                    ...
                    Le terme &ldquo;Impôts&rdquo; inclut ici la somme de votre{' '}
                    <strong>Impôt sur le Revenu</strong> (selon votre TMI) et des{' '}
                    <strong>Prélèvements Sociaux</strong> (17.2%), ou l&apos;Impôt sur les Sociétés
                    (IS) pour une SCI.
                  </p>
                  <ExpertTip variant="success">
              ...
              <CardContent>
                <div className="space-y-6">
                  ...
                  <ExpertTip>
                    ...
                    mensualité est d&apos;environ{' '}
                    <span className="font-bold underline">1 210€</span> dont 50€ d&apos;assurance.
                    Le coût total du crédit est de ~90 000€ d&apos;intérêts + ~12 000€
                    d&apos;assurance.
                  </ExpertTip>
                  <ExpertTip variant="success">
                    <strong>L&apos;effet de levier :</strong> Emprunter à 3.5% pour investir dans un
                    bien qui rapporte 6% net, c&apos;est gagner 2.5% sur de l&apos;argent que vous
                    n&apos;avez pas. C&apos;est le principe fondamental de l&apos;investissement
                    locatif.
                  </ExpertTip>
                </div>
              </CardContent>
          ...
          <section id="assurance-crd" className="space-y-6 scroll-mt-8">
            ...
            <Card>
              ...
              <CardContent className="space-y-6">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                  <div className="bg-surface p-5 rounded-xl border border-sand">
                    ...
                    <p className="text-sm text-pebble leading-relaxed mt-3">
                      Mensualité <strong>constante</strong> sur toute la durée du crédit. C&apos;est
                      le mode par défaut des contrats groupe bancaires.
                    </p>
                ...
                <ExpertTip variant="success">
                  <strong>Impact sur l&apos;investissement :</strong> En mode CRD, l&apos;économie
                  de ~4 800€ sur 20 ans améliore le cash-flow en fin de crédit et augmente le TRI de
                  0.1 à 0.2 point. En LMNP réel / SCI IS, l&apos;assurance déductible diminue chaque
                  année, ce qui augmente légèrement la base imposable en fin de crédit.
                </ExpertTip>

                <ExpertTip variant="warning">
                  <strong>HCSF :</strong> Pour l&apos;analyse d&apos;endettement, la mensualité
                  maximale (An 1) est retenue dans les deux modes. Le mode CRD n&apos;offre donc pas
              ...
              <Card>
                ...
                <CardContent className="space-y-4">
                  ...
                  <p className="text-sm text-pebble leading-relaxed">
                    ...
                    bâti, du mobilier et des travaux permet souvent de ramener l&apos;impôt à zéro
                ...
                <CardContent className="space-y-4">
                  <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
                    ...
                    <div className="bg-white/60 backdrop-blur-sm p-4 rounded-xl border border-sand/30">
                      ...
                      <p className="text-2xl font-black text-charcoal">
                        30%{' '}
                        <span className="text-xs font-normal text-pebble">(sur dividendes)</span>
                      </p>
                    </div>
                  </div>
                  <p className="text-sm text-pebble leading-relaxed">
                    Imposition au niveau de la société avec amortissement comptable. Deux modes de
                    fonctionnement : <strong>capitalisation</strong> (les bénéfices restent dans la
                    SCI) ou <strong>distribution</strong> (dividendes soumis à la flat tax de 30%).
                  </p>
                  <ExpertTip variant="warning">
                    <strong>Attention à la revente :</strong> En SCI IS, la plus-value est calculée
                    sur la valeur nette comptable (après amortissements). L&apos;impôt de plus-value
                    est donc beaucoup plus élevé qu&apos;en nom propre. Voir la section{' '}
              ...
              <CardContent className="space-y-6">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                  <div className="bg-forest/5 p-5 rounded-xl border border-forest/10">
                    ...
                    <p className="text-sm text-pebble leading-relaxed">
                      Imputable sur votre <strong>revenu global</strong> (salaires, etc.) dans la
                      limite de <strong className="text-forest">10 700€/an</strong>.
                    </p>
                ...
                <ExpertTip>
                  ...
                  000€, intérêts 5 000€. Déficit total = 12 200€. Dont 7 200€ hors intérêts
                  imputable sur revenu global. À TMI 30%, l&apos;économie d&apos;impôt est de{' '}
                  <strong>2 160€</strong>.
                </ExpertTip>
                <ExpertTip variant="warning">
                  <strong>Condition :</strong> En contrepartie de l&apos;imputation sur le revenu
                  global, vous devez conserver le bien en location pendant{' '}
          ...
          <section id="amortissement" className="space-y-6 scroll-mt-8">
            ...
            <div className="grid grid-cols-1 gap-6">
              <Card>
                ...
                <CardContent className="space-y-6">
                  <p className="text-sm text-pebble leading-relaxed">
                    L&apos;amortissement permet de déduire chaque année une fraction de la valeur du
                    bien de vos revenus imposables. Seule la partie <strong>bâti</strong> est
                    amortissable — le terrain ne l&apos;est pas.
                  </p>
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                    <div className="bg-surface p-5 rounded-xl border border-sand">
                      ...
                      <p className="text-sm text-pebble leading-relaxed mb-3">
                        ...
                        l&apos;ensemble du bâti. Simple mais sous-estime l&apos;amortissement réel.
                      </p>
                    ...
                    <div className="bg-forest/5 p-5 rounded-xl border border-forest/10">
                      ...
                      <p className="text-sm text-pebble leading-relaxed mb-3">
                        Décomposition du bâti en composants avec des durées différentes. Plus précis
                        et plus avantageux les premières années.
                      </p>
                  ...
                  <ExpertTip variant="warning">
                    ...
                    <strong>déficit BIC</strong>. Si l&apos;amortissement dépasse le bénéfice,
                    l&apos;excédent est reporté sans limite de durée sur les exercices suivants. Il
                    n&apos;est jamais perdu.
                  </ExpertTip>
                </CardContent>
              </Card>
            ...
            <div className="grid grid-cols-1 gap-6">
              ...
              <Card>
                ...
                <CardContent className="space-y-4">
                  ...
                  <p className="text-sm text-pebble leading-relaxed">
                    Depuis la <strong>loi de finances 2025</strong>, les amortissements déduits en
                    LMNP sont réintégrés dans le calcul de la plus-value lors de la revente. Les
                    abattements pour durée de détention s&apos;appliquent ensuite normalement.
                  </p>
                  <ExpertTip variant="warning">
              ...
              <Card>
                ...
                <CardContent className="space-y-6">
                  ...
                  <p className="text-sm text-pebble leading-relaxed">
                    ...
                    <strong>valeur nette comptable</strong>. Après des années d&apos;amortissement,
                    la VNC peut être très faible, ce qui génère une plus-value imposable importante.{' '}
                    <strong>Aucun abattement</strong> pour durée de détention.
                  </p>
                  ...
                  <ExpertTip variant="warning">
                    <strong>Exemple frappant :</strong> Achat 200 000€, revente 230 000€ après 10
                    ans (amortissements 51 510€). En <strong>nom propre : 8 724€</strong>{' '}
                    d&apos;impôt PV. En <strong>SCI IS avec distribution : 35 742€</strong>. Soit{' '}
                    <strong>4x plus</strong>. La SCI IS est un outil de capitalisation long terme,
                    pas de revente rapide.
                  </ExpertTip>
                </CardContent>
              </Card>
            </div>
              ...
              <CardContent className="pt-6">
                ...
                <div className="space-y-4">
                  ...
                  <ExpertTip>
                    ...
                    dérogation de <strong>20%</strong> sur leurs dossiers. Cette marge est souvent
                    réservée aux profils à haut reste à vivre (&gt;1 500€/mois après charges) ou aux
                    primo-accédants résidence principale. Les investisseurs locatifs y ont rarement
                    accès.
                  </ExpertTip>
                  ...
                  <p className="text-sm text-pebble leading-relaxed">
                    Le reste à vivre est le montant qui reste chaque mois après paiement de toutes
                    vos charges et crédits. Les banques l&apos;utilisent systématiquement{' '}
            ...
            <Card>
              ...
              <CardContent className="space-y-6">
                ...
                <ExpertTip variant="warning">
                  ...
                  manque à gagner de <strong>~175€/mois à l&apos;horizon 10 ans</strong> par rapport
                ...
                <ExpertTip variant="warning">
                  ...
                  DPE F ou G (passoire) un malus de <strong>-10 points</strong>. Le simulateur émet
                  des alertes spécifiques si l&apos;interdiction de location tombe avant la fin de
                  votre horizon de projection.
                </ExpertTip>
                <ExpertTip variant="success">
                  <strong>Opportunité :</strong> Un bien en DPE F ou G acheté avec décote + travaux
                  de rénovation énergétique peut être une excellente opération : vous bénéficiez du{' '}
                  <strong>déficit foncier</strong> sur les travaux tout en augmentant la valeur et
                  la performance du bien. Vérifiez votre éligibilité à{' '}
            ...
            <Card>
              ...
              <CardContent className="space-y-8">
                <p className="text-sm text-pebble leading-relaxed">
                  ...
                  neutre), puis chaque critère apporte un <strong>bonus ou malus</strong> selon la
                  qualité du projet. Le résultat est borné entre 0 et 100.
                </p>

                <FormulaBox highlight>
                  Score = 40 (base) + Cashflow + Rentabilité + HCSF + DPE + Ratio prix/loyer + Reste
                  à vivre
                </FormulaBox>
            ...
            <Card>
              ...
              <CardContent className="space-y-6">
                <p className="text-sm text-pebble leading-relaxed">
                  ...
                  positif immédiat) et <strong>moyen pour un patrimonial</strong> (TRI insuffisant
                  sur 20 ans), ou vice-versa. Les deux scores sont calculés simultanément côté
                  serveur et affichés sans recalcul.
                </p>
                ...
                <ExpertTip variant="info">
                  ...
                  (rentabilité et ratio prix/loyer valorisés ×1.5). Même bien, lecture différente
                  selon votre objectif.
                </ExpertTip>

                <ExpertTip variant="warning">
                  <strong>Alerte LMP :</strong> En régime LMNP, si vos recettes annuelles dépassent{' '}
                  <strong>20 000€</strong> (approche du seuil) ou <strong>23 000€</strong> (seuil
                  LMP), un bandeau d&apos;alerte s&apos;affiche automatiquement dans les résultats.
            ...
            <Card>
              ...
              <CardContent className="space-y-6">
                <p className="text-sm text-pebble leading-relaxed">
                  ...
                  intégrant toutes les variables qui évoluent dans le temps : inflation des loyers,
                  hausse des charges, remboursement du crédit et fiscalité réelle.
                </p>
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                  <div className="bg-surface p-5 rounded-xl border border-sand">
                    ...
                    <p className="text-sm text-pebble leading-relaxed">
                      Le TRI mesure la rentabilité annualisée de votre investissement en prenant en
                      compte
                    ...
                    <p className="text-sm text-pebble leading-relaxed mt-2">
                      C&apos;est l&apos;indicateur le plus complet pour comparer un investissement
                      immobilier avec un placement financier (assurance-vie, bourse, etc.).
                    </p>
                  </div>
                  <div className="bg-surface p-5 rounded-xl border border-sand">
                    <h5 className="text-sm font-bold text-charcoal mb-2">
                    ...
                    <p className="text-sm text-pebble leading-relaxed">
                      C&apos;est la mesure réaliste de votre enrichissement, intégrant les flux de
                      trésorerie cumulés :
                    </p>
                    <FormulaBox>
                    ...
                    <p className="text-sm text-pebble leading-relaxed mt-2">
                      ...
                      tient compte de <strong>tout l&apos;argent investi ou perdu</strong> via le
                      cash-flow mensuel. Un investissement avec un fort effort d&apos;épargne aura
                      un patrimoine net bien inférieur à la valeur du bien.
                    </p>
                  </div>
                </div>
                ...
                <p className="text-sm text-pebble leading-relaxed">
                  Le simulateur intègre les frais réels de cession pour un TRI et un enrichissement
                  total réalistes.
                </p>
                <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
                  <div className="bg-surface p-4 rounded-xl border border-sand text-center">
                    ...
                    <p className="text-2xl font-black text-charcoal">
                      5%<span className="text-xs font-normal text-pebble"> du prix de vente</span>
                    </p>
                ...
                <ExpertTip variant="success">
                  <strong>Cash-flow net :</strong> Le tableau de projection montre année par année
                  le cash-flow net d&apos;impôt (loyers − charges − crédit − impôts). Un cash-flow
                  négatif signifie un effort d&apos;épargne mensuel. Suivez l&apos;évolution : avec
                  l&apos;inflation des loyers et la fin du crédit, le cash-flow s&apos;améliore
                  ...
                  <div className="bg-surface p-5 rounded-xl border border-sand space-y-3">
                    ...
                    <div className="flex items-start gap-2 text-sm">
                      ...
                      <div>
                        ...
                        <p className="text-pebble text-xs">
                          Montant d&apos;emprunt restant à rembourser. Atteint 0 à la fin du crédit.
                        </p>
                      </div>
                    </div>
                    <div className="flex items-start gap-2 text-sm">
          ...
          <div className="bg-charcoal text-white rounded-3xl p-8 md:p-12 relative overflow-hidden shadow-2xl">
            <div className="relative z-10 space-y-4">
              ...
              <p className="text-stone-light/70 text-sm leading-relaxed max-w-3xl">
                Ce simulateur fournit des estimations basées sur les informations renseignées et les
                valeurs réglementaires en vigueur. Les calculs fiscaux sont conformes à la
                législation 2025-2026, mais des particularités liées à votre situation personnelle
                peuvent modifier les résultats.
              </p>
              <p className="text-stone-light/70 text-sm leading-relaxed max-w-3xl">
                Pour un conseil personnalisé, consultez un expert-comptable ou un conseiller en
                gestion de patrimoine (CGP). Les prélèvements sociaux, barèmes d&apos;abattement et
                seuils fiscaux sont ceux en vigueur au 1er janvier 2026.
              </p>
            </div>
