...
const mockFormData: CalculateurFormData = {
  ...
  structure: {
    ...
    tmi: 30,
    regime_fiscal: 'reel',
    associes: [{ nom: 'Jean Dupont', parts: 100, revenus: 45000, mensualites: 500, charges: 200 }],
  },
  options: {
    generer_pdf: true,
    envoyer_email: false,
...
const mockResultats: CalculResultats = {
  ...
  hcsf: {
    ...
    conforme: true,
    details_associes: [{ nom: 'Jean Dupont', taux_endettement: 28.5, conforme: true }],
  },
  synthese: {
    score_global: 72,
    recommandation:
      'Cet investissement présente un profil équilibré avec une rentabilité correcte et un cashflow positif. La conformité HCSF est respectée.',
    points_attention: [
