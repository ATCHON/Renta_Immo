    ...
    <View style={styles.card}>
      ...
      <View style={styles.col2}>
        ...
        <View style={styles.flex1}>
          <Text style={[styles.h3, { color: colors.textMuted, fontSize: 10, marginBottom: 8 }]}>
            EMPLOIS
          </Text>
        ...
        <View style={styles.flex1}>
          ...
          <View
            style={[
              styles.mt10,
              { padding: 8, backgroundColor: colors.surfaceHighlight, borderRadius: 4 },
            ]}
          >
            <Text style={[styles.small, { textAlign: 'center', color: colors.textLight }]}>
              L&apos;emprunt couvre{' '}
              {(totalProjet > 0 ? (montantEmprunt / totalProjet) * 100 : 0).toFixed(0)}% du projet
            </Text>
          </View>
        </View>
      </View>
