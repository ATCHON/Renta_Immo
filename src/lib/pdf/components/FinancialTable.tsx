        ...
        <View style={styles.card} wrap={false}>
          ...
          <View style={[styles.col2, { marginBottom: 10 }]}>
            <View style={styles.flex1}>
              <Text style={[styles.h3, { fontSize: 10, color: colors.textMuted }]}>
                Rentabilité
              </Text>
              ...
              <View style={styles.rowBetween}>
                ...
                <Text style={[styles.value, { color: colors.primary }]}>
                  {formatPercent(rentabilite.nette_nette)}
                </Text>
              </View>
            </View>
            ...
            <View style={styles.flex1}>
              ...
              <View style={styles.rowBetween}>
                ...
                <Text
                  style={[
                    styles.value,
                    cashflow.mensuel >= 0 ? styles.textSuccess : styles.textError,
                  ]}
                >
              ...
              <View style={styles.rowBetween}>
                ...
                <Text
                  style={[
                    styles.value,
                    cashflow.annuel >= 0 ? styles.textSuccess : styles.textError,
                  ]}
                >
        ...
        <View wrap={false}>
          ...
          <View style={styles.card}>
            <View style={styles.rowBetween}>
              ...
              <Text style={[styles.value, styles.textError]}>
                {formatCurrency(fiscalite.impot_estime)}
              </Text>
            </View>
            {fiscalite.dividendes_bruts !== undefined && (
              <View style={styles.rowBetween}>
                ...
                <Text style={[styles.value, styles.textError]}>
                  {formatCurrency(fiscalite.flat_tax || 0)}
                </Text>
              </View>
            )}
            <View
              style={[
                styles.rowBetween,
                { marginTop: 4, paddingTop: 4, borderTopWidth: 1, borderTopColor: colors.border },
              ]}
            >
            ...
            {comparaison.items.map((item, index) => (
              ...
              >
                <Text
                  style={[
                    styles.tableCell,
                    { flex: 2, fontWeight: item.isOptimal ? 'bold' : 'normal' },
                  ]}
                >
                  {item.regime} {item.isOptimal && '(Recommandé)'}
                </Text>
                <Text style={[styles.tableCell, styles.textRight, { flex: 1 }]}>
                  {formatCurrency(item.impotAnnuelMoyen)}
                </Text>
                <Text style={[styles.tableCell, styles.textRight, { flex: 1, fontWeight: 'bold' }]}>
                  {formatCurrency(item.cashflowNetMoyen)}
                </Text>
                <Text style={[styles.tableCell, styles.textRight, { flex: 1 }]}>
                  {formatPercent(item.rentabiliteNetteNette)}
                </Text>
              </View>
            ))}
          </View>
              ...
              <View style={styles.flex1}>
                <View style={styles.rowBetween}>
                  ...
                  <Text
                    style={[
                      styles.value,
                      projections.totaux.cashflowCumule >= 0
                        ? styles.textSuccess
                        : styles.textError,
                    ]}
                  >
                ...
                <View style={styles.rowBetween}>
                  ...
                  <Text style={styles.value}>
                    {formatCurrency(projections.totaux.capitalRembourse)}
                  </Text>
                </View>
              </View>
              <View style={styles.flex1}>
                <View style={styles.rowBetween}>
                  ...
                  <Text style={[styles.value, styles.textError]}>
                    {formatCurrency(projections.totaux.impotCumule)}
                  </Text>
                </View>
                <View style={styles.rowBetween}>
