                ...
                {sorted.map((point, index) => {
                    ...
                    return (
                        <View key={index} style={[
                            localStyles.pointRow,
                            isLast ? localStyles.pointRowLast : {},
                        ]}>
                            <View style={[localStyles.badge, { backgroundColor: config.bg }]}>
                                <Text style={[localStyles.badgeText, { color: config.color }]}>
                                    {config.label}
                                </Text>
                            </View>
                            <View style={localStyles.pointContent}>
                                ...
                                {point.conseil && (
                                    <Text style={localStyles.conseil}>{point.conseil}</Text>
                                )}
                            </View>
                        </View>
                    );
