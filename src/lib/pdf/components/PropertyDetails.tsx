    ...
    <View style={styles.card}>
      ...
      <View style={styles.col2}>
        ...
        <View style={styles.flex1}>
          ...
          <Text style={[styles.h3, { fontSize: 10, color: colors.textMuted, marginTop: 12 }]}>
            Exploitation
          </Text>
          <View style={styles.rowBetween}>
          ...
          <View style={styles.rowBetween}>
            ...
            <Text style={[styles.value, { color: colors.success }]}>
              {formatCurrency(exploitation.loyer_mensuel)}
            </Text>
          </View>
          <View style={styles.rowBetween}>
        ...
        <View style={styles.flex1}>
          ...
          <View style={styles.rowBetween}>
            ...
            <Text style={styles.value}>
              {formatPercent(financement.taux_interet)} / {financement.duree_emprunt} ans
            </Text>
          </View>
          <View style={styles.rowBetween}>
