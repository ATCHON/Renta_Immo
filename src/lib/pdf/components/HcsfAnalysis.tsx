    ...
    <View style={styles.section} wrap={false}>
            ...
            >
              ...
              <Text
                style={[
                  ...
                  {
                    flex: 1,
                    color: associe.conforme ? colors.success : colors.error,
                    fontWeight: 'bold',
                  },
                ]}
              >
      ...
      <View style={[styles.card, { backgroundColor: colors.surfaceHighlight, marginTop: 5 }]}>
        ...
        <Text style={{ fontSize: 9, color: colors.textLight, lineHeight: 1.4 }}>
          Le taux d&apos;endettement ne doit pas dépasser 35% des revenus, assurance emprunteur
          incluse. Le calcul prend en compte le différentiel de revenus fonciers (méthode non
          compensatoire).
        </Text>
      </View>
    </View>
