...
4. [x] **Tooltips pédagogiques** expliquant brièvement les avantages/inconvénients de chaque régime. (Implémentés via Descriptions/Badges dans FiscalComparator)
